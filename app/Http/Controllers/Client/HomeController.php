...
class HomeController extends Controller
{
    public function index() {
        ...
        $product_top_sale_1 = Product::where('qty','>',0)->orderBy('qty_buy', 'DESC')->limit(3)->get();
        $product_top_sale_2 = Product::where('qty','>',0)->orderBy('qty_buy', 'DESC')->skip(3)->limit(3)->get();
        $product_top_sale_3 = Product::where('qty','>',0)->orderBy('qty_buy', 'DESC')->skip(6)->limit(3)->get();
